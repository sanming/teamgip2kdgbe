...
import be.kdg.repaircafe.backend.dom.repairs.*;
...
import be.kdg.repaircafe.backend.persistence.api.BidRepository;
...
import be.kdg.repaircafe.backend.services.exceptions.BidServiceException;
